...
title: How to get started with Django on Humalect platform
authors: [Priyansh]
tags: [Python]
---
...
Fork [THIS](https://github.com/Humalect/simple-django-app) sample Django repository to get started.

This Django application exposes a static API that return a static response and runs on port 8000.
...
Create an environment for your Django application. Check for various options that need to be configured to create a new environment or use an existing one.
...
![django-app-project-creation](./django-app-project-creation.png)
...
![django-app-pipeline-creation](./django-app-pipeline-creation-1.png)

next,

![django-app-pipeline-creation](./django-app-pipeline-creation-2.png)
...
![django-app-pipeline-advanced](./django-app-pipeline-advanced.png)
...
![django-app-deploy-pipeline](./django-app-deploy-pipeline.png)
...
![django-app-live](./django-app-live.png)
...
![django-app-logs-metrics](./django-app-logs-metrics.png)
